"""
Django settings for hbbrtt_355 project.
...
WSGI_APPLICATION = 'hbbrtt_355.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hbbrtt_355 API",
    "DESCRIPTION": "API documentation for hbbrtt_355 App",
    "VERSION": "v1",
}
